...
const BlogPosts = () => {
  ...
  const fetchBlogPosts = async () => {
    try {
      const response = await fetch('https://farmtech-vert.vercel.app/api/posts');
  ...
  const handleLike = async (postId) => {
    try {
      const response = await fetch(`https://farmtech-vert.vercel.app/api/posts/${postId}/like`, {
        method: 'POST',
        headers: {
  ...
  const handleDislike = async (postId) => {
    try {
      const response = await fetch(`https://farmtech-vert.vercel.app/api/posts/${postId}/dislike`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleCommentSubmit = async () => {
    try {
      const response = await fetch(`https://farmtech-vert.vercel.app/api/posts/${currentPostId}/comments`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleCommentDelete = async (postId, commentId) => {
    try {
      const response = await fetch(`https://farmtech-vert.vercel.app/api/posts/${postId}/comments/${commentId}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
        },
